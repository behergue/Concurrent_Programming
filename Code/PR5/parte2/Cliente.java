...
public class Cliente {
	...
	public void iniciaCliente() throws UnknownHostException, IOException {
		...
		// indica el inicio de la conexión
		System.out.println("Yo, usuario " + nombreUser + ", estoy estableciendo la conexión");
		...
		while(true) {
			...
			// si la opción introducida no es válida, avisamos por consola al usuario
			else {
