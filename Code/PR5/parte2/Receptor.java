...
// recibir el fichero directamente del cliente que lo envió sin que el oyente servidor 
...
public class Receptor extends Thread{
	...
	// puerto para la conexión con el emisor
	private int puerto;
	...
	public void run() {
		try {
			// se crea el canal para la comunicación con el emisor
			Socket socket = new Socket(dirIP, puerto);
			
			// se crea el flujo para leer del emisor
			BufferedReader lector = new BufferedReader(new InputStreamReader(socket.getInputStream()));
			
			// se lee línea a línea el fichero que hemos pedido y se escribe por consola
			String line, fichero = "";
			while(true) {
